...
class TranslateService
{
	...
	private $language = [
		...
		'en' => [
			...
			'WebIndexIndex' => [
				...
				'full_banner_desc' => "We are a Melboume based furniture maker helping people bring their iadeas to life.",
				...
				'return' => "100% Money Back <span>You have 30 days to Return</span>",
	...
	function trans ($key)
	{
		...
		return $this->language[$lang][$k1][$k2] ?? $this->language['en'][$k1][$k2] ?? '';
	}
}
