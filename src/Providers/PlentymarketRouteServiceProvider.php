...
//		});
		...
		$router->get('/api/index/language', 'Plentymarket\Controllers\Api\IndexController@language');
		...
		$router->get('/index/search', 'Plentymarket\Controllers\Web\IndexController@search');
